...
from envs_.franka_less_sensors_env_ import FrankaLessSensorsEnv_
...
goal = np.array([0.59993331, 0.3899995,  0.47368794])
...
dynamic_human = True
obstacle = True
env = FrankaLessSensorsEnv_(scene_path,dynamic_human=dynamic_human, goal=goal, obstacle = obstacle)
