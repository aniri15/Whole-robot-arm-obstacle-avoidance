...
###############################################################################################
# Create and visualize the obstacles
...
class AnimatorRotationAvoidanceEPFL(Animator):
    def setup(
        ...
        n_traj: int = 20, # how many points will be created
    ):
...
####################################################################################################
# The dynamics of the obstacles, 
# in total four kinds of dynamics are implemented
# the functions are used in the animator to update the position of the obstacles
